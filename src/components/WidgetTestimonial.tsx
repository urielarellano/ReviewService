...
function WidgetTestimonial() {
    ...
    const review = {
        ...
        testimonial: "Uriel is a marketing genius. His advertising is truly breakthrough because it produces results, simple as. I don't often leave reviews but this service deserved it.",
        createdAt: new Date()
    }
